...
- `Exmpeg.Stream.t/0` carries `:audio` or `:video` sub-maps populated
...
- `:video_codec` / `:audio_codec` take encoder short names
  (`"libx264"`, `"libx265"`, `"libvpx-vp9"`, `"libaom-av1"`, `"aac"`,
  `"libopus"`, `"libmp3lame"`, `"flac"`). `"copy"` (or an omitted
